    ...
    function setupRenderEffect(instance, vnode, container, anchor) {
        ...
        instance.update = effect(() => {
            ...
            if (!instance.isMounted) {
                ...
                // 更新el、props、vnode
                // 父组件初次触发更新时，父组件更新它的element，再走到更新children逻辑
                // 最后在updateComponent中会判断props是否改变
                // 再次调用instance.update进入这里更新子组件
                const { next } = instance;
                if (next) {
                    // 更新el
                    next.el = vnode.el;
...
export { createApp, createAppApi, createVNode as createElementVNode, createRenderer, createTextVNode, effect, getCurrentInstance, h, inject, nextTick, provide, ref, registryRuntimeCompiler, renderSlots, toDisplayString };
